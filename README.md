...
![Screenshot 2024-01-04 134951](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/e66ffff1-21d3-4c84-875f-277123544b39)

2. Get the commands using the verb `Get` from the `PSReadLine` module.
![Screenshot 2024-01-04 135000](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/1178171c-73d6-4b88-9a20-af5bb11ae9d2)

3. Display all fils under /usr/bin that are larger than 5 MB.
![Screenshot 2024-01-04 170601](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/db6742e1-282d-4e89-9326-9f8498f0b7eb)

4. Find all modules on the PowerShell Gallery that start with `PS` and the author starts with Microsoft
![Screenshot 2024-01-04 171108](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/1af3345c-10e3-480e-869c-90923f35c4cc)

5. Get the files in the current directory where the `LastWriteTime` is in the last week.
![Screenshot 2024-01-04 171756](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/cbc98644-8b60-49c7-bd3c-bff8ac18a383)

6. Display a list of all processes running with either the name `pwsh` *or* the name `bash`.
![Screenshot 2024-01-04 172503](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/10216963-1dab-4b0b-bc15-e7cb1a71281b)

# 13.11 Lab 

1. make a one-to-one connection with a remote compuer (or with `localhost` if you have only one computer). Launch your favorite text editor. What happens?
![Question 1](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/8994ebb7-d4e7-4062-a30d-babbfbd37623)

2. Using `Invoke-ScriptBlock`, retrieve a list of processes currently running from one or two remote computers (it's only to use `localhost` twice if you have only one computer). Format the results as a wide list.
...
4. Create a text file that contains three computer names, with one name per line. It's okay to use the same computer name, or `localhost`, three times if you have access to only one computer. Then use `Invoke-ScriptBlock` retrieve the 10 newest files from the home directory (~).
...
![iM7MkgHPo9](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/00fb9c37-a458-4aaa-9594-c91a73147a7c)
![AFY4zbaKHL](https://github.com/johnnyh209/PowerShell-Exercises/assets/33064730/a4d98ab3-97a1-4864-aa18-3bdc66aed9ef)
